...
IMUPreintegration::IMUPreintegration(const rclcpp::NodeOptions & options) : ParamServer("lio_sam_imu_preintegration", options)
{
    ...
    correctionNoise = gtsam::noiseModel::Diagonal::Sigmas((gtsam::Vector(6) << 0.05 / 50 , 0.05 / 50, 0.05 / 50, 0.1 / 50, 0.1 / 50, 0.1 / 50).finished()); // rad,rad,rad,m, m, m
